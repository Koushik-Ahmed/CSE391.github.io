...
<head>
	...
	<?php
		...
		$db = mysqli_select_db($connection,"sdms");
	?>
</head>
<body>
	<div id="header"><br>
	...
	<span id="top_span"><marquee>Note:- Spring 2022 semester will start from 1st January.</marquee></span>
	<div id="left_side">
		<br><br><br>
		<form action="" method="post">
			<table>
				...
				<tr>
					<td>
						<a href="department_info.php" style="margin-left: 2px;" > Department </a> <br>
					</td>
				</tr>
				<tr>
				    <td>
						<a href="exam_info.php" style="margin-left: 2px;" > Exam </a> 
					</td>
				</tr>
			</div>
			</table>
	...
	<div id="right_side"><br><br>
		...
		<!-- #Code for search student---Start-->
			<?php
				if(isset($_POST['search_student']))
				{
					...
					<center>
					<form action="" method="post">
					&nbsp;&nbsp;<b>Enter ID:</b>&nbsp;&nbsp; <input type="text" name="roll_no">
		...
		<?php
			if(isset($_POST['delete_student']))
			{
				?>
				<center>
				<br><h5>Enter Student ID to Delete Student</h5><br><br> 
